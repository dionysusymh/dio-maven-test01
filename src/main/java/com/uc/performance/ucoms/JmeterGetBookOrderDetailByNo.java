...
public class JmeterGetBookOrderDetailByNo extends AbstractJavaSamplerClient {

	public static final String REMOTE_SERVICE = "ucoms.bookOrderRemoteService.queryBookOrderDetail";
...
//				System.out.println(result.getMsg());
	...
	public void test() {
		...
		args1.addArgument("bookOrderNo", "PS010220160606015");
		args1.addArgument("mobile", "15842532217");
