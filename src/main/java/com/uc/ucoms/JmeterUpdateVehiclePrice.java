...
public class JmeterUpdateVehiclePrice extends AbstractJavaSamplerClient {

	public static final String REMOTE_SERVICE = "ucoms.salePriceRemoteService.updateVehiclePrice";
	...
	public void setupTest(JavaSamplerContext context) {
		...
		// client =
		// RemoteClientFactory.getInstance("http://omstest.maimaiche.com/ucoms",
		// RemoteType.HESSIAN);
		client = RemoteClientFactory.getInstance("http://omstest2.maimaiche.com/ucoms", RemoteType.HESSIAN);
	...
	public Arguments getDefaultParameters() {
		...
		args.addArgument("salePrice", "${salePrice}");
		return args;
	}
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			...
			map.put("salePrice", context.getIntParameter("salePrice"));
	...
	public void test() {
		...
		args1.addArgument("salePrice", "340011");
